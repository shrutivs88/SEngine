  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header  text-center" style="background-color: #55bcc9; color:#fff;">
        ...
        <h3 class="modal-title" style="color: white;">Update Client Details</h3>
      </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="clientEmail2" name="clientEmail2" type="text" class="form-control" placeholder="Enter Your email-id 2" onfocusout="validateClientEmail2()" > 
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="clientEmail3" name="clientEmail3" type="text" class="form-control" placeholder="Enter Your email-id 3" onfocusout="validateClientEmail3()" > 
...
<div id="myModalCompany" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header  text-center" style="background-color:#55bcc9;">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h3 class="modal-title" style="color: white;">Client Company Details</h3>
      </div>
      <div class="modal-body" style="background-color:#e7efdd;">
      <!-- modal body starts here -->
