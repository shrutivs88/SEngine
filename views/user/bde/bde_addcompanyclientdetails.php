...
function validateContactFields() {
       ...
       // validateClientEmail();
        ...
        (clientPhone1ErrorFlag==false)&& (clientCategoryErrorFlag == false) && (clientDesignationErrFlag == false) && (clientPhone2ErrorFlag==false) && (clientCityErrorFlag==false)&&
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div id="contact-phone1-div" class="form-group form-group-mod">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="clientPhone1" id="clientPhone1" type="text" placeholder="Enter valid Phone number" class="form-control" onfocusout="validateClientPhone1()">
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div id="contact-phone2-div" class="form-group form-group-mod">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="clientPhone2" id="clientPhone2" type="text" placeholder="Enter valid Phone number" class="form-control" onfocusout="validateClientPhone2()">
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
