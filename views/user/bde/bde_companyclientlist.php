...

        {
            ...
            $.ajax({
                    ...
                    for(var i=0; i<response.length; i++) { 
                                    ...
                                    bdeListBuilder += "<td><button class='btn action-btn' title='Edit Company' onclick='showCompany(" + response[i].id + ")'><span class='glyphicon glyphicon-edit'></span></button></td>'";

                                    bdeListBuilder += "<td><button class='btn action-btn' id='add-btn' title='Add Client Contact' onclick=addContentOfClient(" + response[i].id + ")><span class='glyphicon glyphicon-plus'></span></button>&nbsp;&nbsp;</td>";
                                  ...
                                  /*  bdeListBuilder += "<td><button class='btn btn-danger action-btn' title='Delete Company' onclick='showDeleteCompany(" + response[i].id + ")'><span class='glyphicon glyphicon-trash'></span></button></td>'"; */
                                    ...
                                    bdeListBuilder += "<td><button class='btn action-btn' title='Show Client Contacts' onclick='showContacts(" + response[i].id + ")'><span class='glyphicon glyphicon-pawn'></span></button></td>'";
                        ...
                        <div class="col-sm-12">
                            ...
                            <div style="overflow-x:auto;">
                                ...
                                <div class="text-center" style="margin-top: 10px;">
                                    ...
                                    <input type="button" class="btn btn-load" value="Load More" id="ajaxButton"/>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <h3 class="modal-title text-center">Edit Client Company Details</h3>
