    ...
    <div class="content-view">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h2 class="add-bdm text-center">Configurations / Mail Configuration / Mail Template / Template List</h2>
    ...
    <div id="mailTemplateFormModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#55bcc9 ; color: white;">
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    templateListBuilder += "<tr style='background-color: #c9e1c1;'>";
                    ...
                    for(var i=0; i<response.length; i++) {
                        ...
                        templateListBuilder += "<td style='display:flex;border:0;'><button class='btn  action-btn' onclick='editTemplate(" + response[i].mailTemplateId + ")'><span class='glyphicon glyphicon-edit'></span></button><button class='btn  action-btn' onclick='deleteTemplate(" + response[i].mailTemplateId + ")'><span class='glyphicon glyphicon-trash'></span></button></td>";
                        templateListBuilder += "</tr>";
                    }
                    templateListBuilder += "</tbody>";
