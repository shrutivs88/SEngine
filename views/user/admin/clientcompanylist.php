...
<body>
    ...
    <div class="content-view">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h2 class="add-bdm text-center">Client Company List</h2>
                    ...
                    <div class="list-search-box">
                        <div class="row">
                            <div class="input-group">
                                <input type="text" id="search-box" name="search-box" class="form-control" placeholder="Search By Name Or Website">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.length == 0 && isUpdateOffsetPristine == true) {
                    $("#company-msg-div").html("<h4 class='text-center'>No Companies Are Available!</h4>");
                    $("#load-more-btn").hide();
                    return;
                } else if(response.length == 0 && isUpdateOffsetPristine == false) {
                    $("#company-msg-div").html("<h4 class='text-center'>No More Companies Are Available!</h4>");
                    $("#load-more-btn").hide();
                    return;
                }
            ...
            error: function(response) {
                $("#company-msg-div").html("<h4 class='text-center'>Something Went Wrong!</h4>");
    ...
    function search() {
        $.ajax({
            type: "POST",
            url: "<?php echo BASEURL ?>actions/admin/performsearchcompanies.php",
            data: {
            ...
            success: function(response) {
                ...
                $("#company-list").html(companyListBuilder);
                if(response.length == 0) {
                    $("#company-msg-div").html("<h4 class='text-center'>No BDMs Are Available!</h4>");
                } else {
                    $("#company-msg-div").html("");
                }
                $("#load-more-btn").hide();
            }
        });
