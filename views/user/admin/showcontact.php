...
<body>
                        ...
                        <div class="panel-body">
                            ...
                            <form id="contact-form" action="<?php echo BASEURL; ?>actions/admin/performupdatecontact.php" method="post">
                                <table class="table table-bordered app-table-theme">
                                    ...
                                    <tr id="contact-email2-tr">
                                        <th>Email 2</th>
                                        <td id="contact-email2-td"></td>
                                    </tr>
                                    <tr id="contact-email3-tr">
                                        <th>Email 3</th>
                                        <td id="contact-email3-td"></td>
                                    </tr>
                                    ...
                                    <tr id="contact-phone1-tr">
                                        <th>Phone no.1</th>
                                        <td id="contact-phone1-td"></td>
                                    </tr>
                                    <tr id="contact-phone2-tr">
                                        <th>Phone no.2</th>
                                        <td id="contact-phone2-td"></td>
                                    </tr>
    ...
    <script>
        ...
        function loadContact(contactId) {
            $.ajax({
                ...
                success: function(contactResponse) {
                    ...
                    var emails = contactResponse.email;
                    var email = emails.split(",");
                    $("#contact-email-td").text(email[0]);
                    $("#contact-email2-td").text(email[1]);
                    $("#contact-email3-td").text(email[2]);
                    $("#contact-category-td").text(contactResponse.category);
                    $("#contact-designation-td").text(contactResponse.designation);
                    $("#contact-phone1-td").text(contactResponse.phone1);
                    $("#contact-phone2-td").text(contactResponse.phone2);
        ...
        function buildAllInputFields() {
            ...
            $("#contact-email2-td").html("<input id='contact-email2' name='contact-email2' type='text' class='form-control inline-form-control' value='" + $("#contact-email2-td").text() + "' onfocusout='validateContactEmail2()'>");
            $("#contact-email3-td").html("<input id='contact-email3' name='contact-email3' type='text' class='form-control inline-form-control' value='" + $("#contact-email3-td").text() + "' onfocusout='validateContactEmail3()'>");
            ...
            $("#contact-phone1-td").html("<input id='contact-phone1' name='contact-phone1' type='text' class='form-control inline-form-control' value='" + $("#contact-phone1-td").text() + "' onfocusout='validateContactPhone1()'>");
            $("#contact-phone2-td").html("<input id='contact-phone2' name='contact-phone2' type='text' class='form-control inline-form-control' value='" + $("#contact-phone2-td").text() + "' onfocusout='validateContactPhone2()'>");
