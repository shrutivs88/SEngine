                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div id="contact-phone1-div" class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Phone No.1</label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="Enter Phone 1 Number" class="form-control" onfocusout="validateContactPhone1()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div id="contact-phone2-div" class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Phone No.2</label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="Enter Phone 2 Number" class="form-control" onfocusout="validateContactPhone2()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
