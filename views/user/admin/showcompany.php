        ...
        function showContacts() {
            $.ajax({
                ...
                success: function(contactResponse) {
                    ...
                    contactListBuilder += "<tr style='background-color: #c9e1c1;'>";
                   ...
                   // contactListBuilder += "<th>Mobile</th>";
                    contactListBuilder += "<th>Phone No.1</th>";
                    contactListBuilder += "<th>Phone No.2</th>";
                    ...
                    for(var i=0; i<contactResponse.length; i++) {
                        ...
                        contactListBuilder += "<td>" + contactResponse[i].phone1 + "</td>";
                        contactListBuilder += "<td>" + contactResponse[i].phone2 + "</td>";
                        contactListBuilder += "<td style='display:flex;'><button class='btn btn-default action-btn' onclick='showContact(" + contactResponse[i].id + ")'><span class='glyphicon glyphicon-eye-open'></span></button><button class='btn btn-default action-btn' onclick='deleteContact(" + contactResponse[i].id + ")'><span class='glyphicon glyphicon-trash'></span></button></td>";
                        contactListBuilder += "</tr>";
                    }
                    contactListBuilder += "</tbody>";
